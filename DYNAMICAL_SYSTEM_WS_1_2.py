...
WS0 = 1.2 #+ np.random.normal(loc=0.0, scale=sigma, size=None)
...
# import pandas
pandas.DataFrame(FIBp).to_csv("FIBp_WS_1_2_csv", header=None)
#pandas.DataFrame(FIBp).to_csv("FIBp.csv",header=None) # , index=None)
pandas.DataFrame(FIBm).to_csv("FIBm_WS_1_2_csv", header=None)
pandas.DataFrame(FIBa).to_csv("FIBa_WS_1_2_csv", header=None)
pandas.DataFrame(COL).to_csv("COL_WS_1_2_csv", header=None)
pandas.DataFrame(N).to_csv("N_WS_1_2_csv", header=None)
pandas.DataFrame(P).to_csv("P_WS_1_2_csv", header=None)
...
aggr[:,4] = N
aggr[:,5] = P
pandas.DataFrame(aggr).to_csv("all_data_multi_d_WS_1_2.csv", header=None)

dataset = pandas.read_csv('all_data_multi_d_WS_1_2.csv', header=0, index_col=0)
...
pandas.DataFrame(reframed).to_csv("all_data_multi_d_WS_1_2_reframed.csv", header=None)
